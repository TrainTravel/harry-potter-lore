...
from .metrics import deep_research_metric, socratic_metric
...
def main() -> int:
    ...
    print(f"\n[1/2] Compiling deep_research ({len(research_trainset)} examples)...")
    ...
    print(f"\n[2/2] Compiling guided_learning ({len(learning_trainset)} examples)...")
